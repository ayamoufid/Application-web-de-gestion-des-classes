  ...
  <div class="bar">
    ...
    <form method="POST" action="">
      ...
      <table>
        <tr>
          <td>Nom du cours</td>
          <td><input type="text" name="nom_cours" ><br><br></td>
        </tr>
        <tr>
          <td>Nom de formation</td>
          <td><input type="text" name="nom_formation" ><br><br></td>
        </tr>
        <tr>
          <td>Semestre</td>
          <td><input type="text" name="semestre" ><br><br></td>
        </tr>
        <tr>
          <td>Annee universitaire</td>
          <td><input type="text" name="annee_univ" ><br><br></td>
        </tr>
        <tr>

          <td style="text-align:right;"><input  type="submit" name="btn1" id="submit" value="Creer"></td>
        </tr>
      </table>
    </form>
  </fieldset>
