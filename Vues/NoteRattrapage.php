...
<table class="table">
  <tr style="background-color: purple;">
    ...
    <th  style="width:10%">  NOM   </th>
     <th style="width:30%">Note examen rattrapage</th>

   
  </tr>
  <form method="POST" action="NoteRattrapage.php?idclasse=<?php echo $_GET['idclasse']; ?>">
 ...
 <?php 
  ...
  <tr>
    ...
    <td><?php echo  $info[$i]['NOM_ETUDIANT']; ?></td>
     <?php  $d = $note->existe_note_type_etu($id_classe,2,$info[$i]['CNE']);  ?> 
      <td><input type="number" name="noten[<?php echo $info[$i]['CNE'] ;?>]" step="0.01" min="0" max="20" value=<?php if (isset($d['NOTE'])) {
        echo $d['NOTE'] ;
      }else echo 0;?> ></td>
